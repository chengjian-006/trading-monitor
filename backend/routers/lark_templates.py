...
register("买入信号", "回踩10MA缩量后突破昨高", "检测到回踩MA10缩量后放量突破昨高, 触发买入",
         _card_v2("🟢 买入信号 · 多氟多", "red", [
             _md("**回踩10MA缩量后突破昨高** 缩量后放量突破昨高\n"
                  "触发价 **32.50** · 现价 **33.18** (+2.09%)\n"
                  "缩量回踩MA10(昨量是均量的0.62倍) → 突破昨高2.5%(触发价31.73) ｜ 实时成交额3.5亿"),
             _md("📊 **所属板块**：PCB·覆铜板\n升温🔥 · 今日涨停 **6** 家 · 近3日 4→5→6 走强"),
             _md("**战绩**: 近3月胜率 61% · 单笔均+3.2% · 全模型第2名 · 盈利因子2.15"),
             _table(
...
register("卖出信号", "弱势极限止损卖出", "弱势极限持仓触发止损条件, 提醒卖出",
         _card_v2("🔴 卖出信号 · 三花智控", "green", [
             _md("**弱势极限·止损卖出** (建仓买点: BUY_WEAK_EXTREME)\n"
                  "触发价 **18.20** · 成本 **21.50** · 亏损 **-15.3%**\n"
                  "触发原因: 收盘价跌破MA60×0.97(剩半清仓) ｜ 持仓12天"),
             _md("📊 **所属板块**：固态电池·锂电\n退潮📉 · 今日涨停 **2** 家 · 近3日 7→4→2 走弱"),
             _md("**持仓回顾**: 入场2026-05-20 @22.80 · 最高@24.50(+7.5%) · 未触发止盈"),
         ]), "盘中实时 · 止损触发立即推送")
         ...
         _card_v2("⚠️ 自选股黑天鹅预警", "blue", [
             ...
             _table(
                 [{"name": "stock", "display_name": "股票", "data_type": "text", "width": "24%"},
                  {"name": "score", "display_name": "风险分", "data_type": "text", "width": "14%"},
                  {"name": "flags", "display_name": "财务红旗", "data_type": "text", "width": "62%"}],
                 [{"stock": "诺德股份\n600110", "score": "70", "flags": "连续亏损·累计亏损-1.1亿·存贷双高"},
                  {"stock": "黄河旋风\n600172", "score": "70", "flags": "连续亏损·累计亏损-27.2亿·高杠杆91%"},
                  {"stock": "东方财富\n300059", "score": "55", "flags": "利润现金流背离·高杠杆77%"},
                  {"stock": "弘信电子\n300657", "score": "30", "flags": "累计亏损-3.8亿·高杠杆80%"}],
             ),
