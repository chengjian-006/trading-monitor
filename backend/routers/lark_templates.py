...
register("盘后提醒", "预增榜·当日正向业绩预告", "盘后把当日新出的正向业绩预告捞出来(自选置顶+全市场大幅预增), 克制使用",
         _card_v2("📈 预增榜·当日正向业绩预告", "red", [
             ...
             # v1.7.x markdown表格版式(飞书markdown组件渲染, 手机整齐不截断; 替代原生table组件)
             _md("**🎯 你的自选/持仓命中 1 只**（🔴持仓 ⭐自选）\n\n"
                 "| 股票 | 净利变动 |\n| --- | --- |\n"
                 "| 🔴华银电力(600744) | 预增 +3601%~+4423% |"),
             _md("**全市场大幅预增 Top3**（按净利变动幅度）\n\n"
                 "| 股票 | 净利变动 |\n| --- | --- |\n"
                 "| 南方精工(002553) | 扭亏 +28647%~+35784% |\n"
                 "| 三和管桩(003037) | 预增 +3091%~+3889% |\n"
                 "| 某某股份(60XXXX) | 预增 +500%~+800% |"),
