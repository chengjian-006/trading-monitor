...
# ═══════════════════════════════════════════
register("买入信号", "二波过前高", "盘中分时二波过前高实时提醒: 第一波放量冲高→回落降温→第二波放量拉升创当日新高(确认后报), 全自选每股每天一次, 只提醒不落信号库",
         _card_v2("🔥 二波过前高 · 卫星化学(002648)", "red", [
             _md("**卫星化学(002648)**　现价 ¥23.69（+4.1%）\n"
                 "　突破第一波高点 ¥23.40（10:12冲高 → 回落 -1.8% → 二波放量 2.1× 拉升 +1.5% 创当日新高）\n"
                 "　[📈 看分时图](#)\n"
                 "　[🔕 当日不提醒](#)　·　[🔕 本周不提醒](#)"),
             _md("抬头看一眼·形态提示非买卖建议(历史多为隔日T+1~T+3小余温, 当日≈走平)。"),
         ]), "盘中09:45~15:00每30秒 · 纯读分时缓存判二波过前高 · 每股每天一次 · surge_snooze逐票静音")
...
register("风险预警", "板块共振·禁补仓", "大盘正常但某行业集体大跌(超出大盘≥20pp)时, 自选池命中行业合并提示禁抄底/禁补仓; 回测背书该语境抄底期望为负; 恐慌普跌日不适用不发",
         _card_v2("⛔ 板块共振·禁补仓 · 2个行业", "orange", [
             _md("**有色金属-能源金属-锂**　行业大跌占比 **100%**（6/6） ｜ 全市场 5.2%\n"
                 "　💼融捷股份(002192) **-10.0%**"),
             _md("**电力设备-电池-电池化学品**　行业大跌占比 **71%**（27/38） ｜ 全市场 5.2%\n"
                 "　💼天华新能(300390) **-15.8%**　┃　海科新源(301292) **-7.0%**"),
             _md("大盘正常但行业集体大跌=行业逻辑受损。全市场回测(2023~2026): 此语境抄底/补仓 "
