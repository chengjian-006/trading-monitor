...
register("盘面分析", "板块弱转强·失败", "早先推过启动的题材涨停回落, 补一条失败提醒(每题材当日一次)",
         _card_v2("⚠️ 板块弱转强·失败", "blue", [
             _table(
                 ...
                 [{"theme": "机器人", "peak": "7家→3家", "yest": "3家", "rep": "天安新材、长盛轴承"}],
             ),
...
register("盘后提醒", "财报披露日历·近期", "自选/持仓里未来7天内要披露定期报告的票, 盘前提醒(防御避险)",
         _card_v2("📅 财报披露日历·近期", "blue", [
             ...
             _table(
                 ...
                 [{"stock": "宁德时代(300750)", "rpt": "2025半年报", "day": "2025-08-15·3天后", "flag": "🔴持仓"},
                  {"stock": "比亚迪(002594)", "rpt": "2025半年报", "day": "2025-08-18·6天后", "flag": "自选"},
                  {"stock": "隆基绿能(601012)", "rpt": "2025半年报", "day": "2025-08-19·7天后", "flag": "自选"}],
             ),
         ]), "交易日 08:40 · 自选+持仓未来7天内有披露才发")

register("盘后提醒", "预增榜·当日正向业绩预告", "盘后把当日新出的正向业绩预告捞出来(自选置顶+全市场大幅预增), 克制使用",
         _card_v2("📈 预增榜·当日正向业绩预告", "red", [
             _md("今日新出正向业绩预告 **937** 条。⚠️ 回测: 好业绩涨在公告那一下、之后D+2→D+5阴跌(利好兑现), "
             ...
             _table(
                 ...
                 [{"stock": "华银电力(600744)", "ptype": "预增", "amp": "+3601%~+4423%", "tag": "🔴持仓"}],
             ),
             ...
             _table(
                 [{"name": "stock", "display_name": "股票", "data_type": "text", "width": "26%"},
                  ...
                  {"name": "amp", "display_name": "净利变动", "data_type": "text", "width": "24%"},
                  {"name": "tag", "display_name": "", "data_type": "text", "width": "34%"}],
                 [{"stock": "南方精工(002553)", "ptype": "扭亏", "amp": "+28647%~+35784%", "tag": ""},
                  {"stock": "三和管桩(003037)", "ptype": "预增", "amp": "+3091%~+3889%", "tag": ""},
                  {"stock": "某某股份(60XXXX)", "ptype": "预增", "amp": "+500%~+800%", "tag": ""}],
             ),
