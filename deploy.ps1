...
Write-Host "[1/6] Building frontend locally..." -ForegroundColor Yellow
...
Write-Host "[2/6] Building site (官网) locally..." -ForegroundColor Yellow
...
Write-Host "[3/6] Packing files (含本地build好的 frontend/dist + site/dist)..." -ForegroundColor Yellow
$excludes = @(
...
Write-Host "[5/6] Extract + Python deps (服务器不再build前端)..." -ForegroundColor Yellow
