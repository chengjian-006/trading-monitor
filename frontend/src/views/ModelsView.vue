...
const FLOW_STAGES: Record<string, FlowStage[]> = {
  ...
  BUY_STRONG_START: [{label:'前置条件',color:'#3b82f6',items:['满足弱势极限缩量地量基础']},{label:'触发条件',color:'#16a34a',items:['放量≥近期×2','涨幅≥2%','站上MA10/20','全天额≥10亿(外推)','实时累计额≥5亿(破即触发,不卡10点)','距弱势极限基准涨幅≤10%(挡晚到追高)']},{label:'出场规则',color:'#ea580c',items:['+7%卖半','剩半破MA10×0.98','-6%止损','T+10时停']}],
